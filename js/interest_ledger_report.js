...
function getDailyTable() {
    $.post('reportFile/intrest_loan_report/getInterestLoanLedgerViewReportDaily.php', {}, function (data) {
        $('#daily_table_div').empty().html(data);
    });
}

function getMonthlyTable(monthly_date) {
    $.post('reportFile/intrest_loan_report/getInterestLoanLedgerViewReportMonthly.php', { monthly_date }, function (data) {
