$(document).ready(function () {
    ...
    $('#search').click(function () {
        let cus_id = $('#cus_id').val(); let first_name = $('#first_name').val(); let last_name = $('#last_name').val(); let area = $('#cus_area').val();
        ...
        if (validate()) {
            $.ajax({
                ...
                type: 'POST',
                data: { cus_id, first_name, last_name, area, mobile , fingerprint_person_id },
                dataType: 'json',
...
function validate() {
    let response = true;
    let cus_id = $('#cus_id').val(); let first_name = $('#first_name').val(); let last_name = $('#last_name').val(); let area = $('#cus_area').val(); let mobile = $('#mobile').val(); let fingerprint_person_id = $('#fingerprint_person_id').val();

    if (cus_id == '' && first_name == '' && last_name == '' && area == '' && mobile == '' && fingerprint_person_id == '') {
        response = false;
