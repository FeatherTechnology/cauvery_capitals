    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><?php echo "<span class='btn btn-success noc-window' style='font-size: 17px;position: relative;top: 0px; background-color:#0c70ab;' data-value='" . $row['req_id'] . "''>NOC</span>"; ?></td>
