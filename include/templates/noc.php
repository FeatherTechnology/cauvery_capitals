							...
							<div class="row">
								...
								<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
									<div class="form-group">
										...
										<button type="button" class='btn btn-success scanBtn' id="" name="" style='background-color:#0c70ab;margin-top: -50px;width: auto;' onclick="event.preventDefault()" title='Put Your Thumb' tabindex='43'><i class="material-icons" id="icon-flipped">&#xe90d;</i>&nbsp;Scan</button>
