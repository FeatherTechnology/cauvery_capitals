                            ...
                            <div class="row" id="customer" <?php if (isset($raisingFor) and $raisingFor == '4'){ }else{ echo 'style="display: none;"'; } ?> > <!-- When Raising For is customer Means customer will show -->
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name" tabindex='6' value="<?php if (isset($first_name)) echo $first_name; ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="last_name" name="last_name" tabindex='6' value="<?php if (isset($last_name)) echo $last_name; ?>" readonly>
                                    </div>
                                </div>
