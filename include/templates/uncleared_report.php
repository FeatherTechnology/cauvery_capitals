...
<div class="page-header">
	<div style="background-color:#0c70ab; width:100%; padding:12px; color: #ffff; font-size: 20px; border-radius:5px;">
		Marudham Capitals - Uncleared Report
	</div>
</div><br>
...
<div class="main-container">
	<!--form start-->
	<form id="uncleared_report_form" name="uncleared_report_form" action="" method="post" enctype="multipart/form-data">
		...
		<div class="row gutters" id="uncleared_card">
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="card">
					<div class="card-header">Uncleared Report</div>
					<div class="card-body">
