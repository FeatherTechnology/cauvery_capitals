...
try{
    ...
    $insertQry = "INSERT INTO `collection`(  `coll_code`, `req_id`, `cus_id`, `cus_name`, `branch`, `area`,  `line`, `loan_category`, `coll_status`, 
        ...
        '" . strip_tags($penalty) . "','" . strip_tags($coll_charge) . "',
        ...
        '" . strip_tags($pre_close_waiver) . "', '" . strip_tags($principal_waiver) . "', '" . strip_tags($interest_waiver) . "','" . strip_tags($penalty_waiver) . "','" . strip_tags($coll_charge_waiver) . "','" . strip_tags($total_waiver) . "',$userid,current_timestamp )";
